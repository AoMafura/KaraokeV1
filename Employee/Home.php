    ...
    <div class = "container home">
        <div class = "row">
            <div class = "col-sm-12 home right">
                ...
                <center>
                <div class="row">
                    <div class = "mx-auto col-sm-9 brand mt-5">
                        <img id="logo" class="mt-5" src="logo.png" alt="">
                        <img id="title" class="mt-5" src="title.png" alt="">
                    </div>
                </div>
                </center>
                ...
                <div class="row">
                    <div class = "col-sm-2 mt-5 ml-auto mr-5 p-3">
